...
<div id="formContainer">
	...
	<p>
		Dear Mr/Mrs <?php echo $_POST['last_name']; ?>
	</p>
	<p>
		Thank you for your interest in DMACC. We have you listed as an <?php echo $_POST['grade_select'] ?> and, you have declarded <?php echo $_POST['major'] ?> as your major
	</p>
	<p>
		Based upon your responses we will provide the following information in our conformation email to you at (put email thing here). 
	</p>
	<span>
		<p><?php echo "<li>" . $_POST['program_information'] . "</li>"?> </p> <!-- Need to figure out how to display blank if check box is not selected -->
		<p><?php echo "<li>" . $_POST['program_advisor'] . "</li>"?> </p>
	</span>
	<p>
