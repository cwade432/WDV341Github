...
if( isset($_POST['submit'])){
    ...
    if( $validForm ){
        ...
        try{
            ...
            $sql = "UPDATE wdv341_events SET event_name = :name, event_description = :desc, event_presenter = :presenter WHERE event_id = :eventId";
    ...
    $eventId = $_GET['eventId']; // getting param from the select event page

    //echo "<h1>Event id from insert " . $eventId . "</h1>";
